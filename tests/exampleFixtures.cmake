...
set(RIGEXEC_EXAMPLE_FIXTURES
    # -- the numbered tour -------------------------------------------------
    "01_FkChainTail.usda|1001,1012,1024,1036,1048|/TailAsset/Rig/Controls/Tail2|avars:rz|/TailAsset/Rig/Weights/Seg2W|rigExec:defaultWeight|NO|weights"
    "02_TwoBoneIkLeg.usda|1001,1016,1024,1032,1048|/LegAsset/Rig/Controls/FootIK|avars:ty|/LegAsset/Rig/Weights/KneeDriven|inputs:driver|NO|weights"
    "03_IkFkBlendClamp.usda|1001,1020,1024,1028,1048|/BlendArmAsset/Rig/Controls/HandIK|avars:tx|/BlendArmAsset/Rig/Solvers/IKFKBlend|inputs:weight|NO|weights"
    "04_BlendShapeFace.usda|1001,1016,1024,1040,1048|-|-|/FaceAsset/Rig/BlendInputs/Smile|inputs:weight|NO|weights"
    "05_TwistRibbonSpine.usda|1001,1012,1024,1036,1048|/SpineAsset/Rig/Controls/ChestCtl|avars:rz|/SpineAsset/Rig/Weights/FinW|rigExec:defaultWeight|NO|solvers"
    ...
    "08_AimEyes.usda|1001,1012,1016,1032,1048|/EyesAsset/Rig/Controls/LookAt|avars:tx|/EyesAsset/Rig/Movers/Pose/AimL|inputs:defaultWeight|NO|weights"
    "09_PropertyMathMovers.usda|1001,1012,1024,1036,1048|/PropMathAsset/Rig/Controls/RootCtl|avars:ry|/PropMathAsset/Rig/Movers/ClampGain|inputs:max|NO|weights"
    ...
    "12_CurvenetProfile.usda|1001,1012,1024,1036,1048|/CurvenetAsset/Rig/Controls/BendCtl|avars:rz|/CurvenetAsset/Rig/Movers/Geometry/ProfileMover|inputs:defaultWeight|NO|weights"
    "13_ReadPhases.usda|1001,1012,1024,1036,1048|/ReadPhaseAsset/Rig/Controls/LiftCtl|avars:ty|/ReadPhaseAsset/Rig/Weights/CageW|rigExec:defaultWeight|NO|weights"
    # -- the constraint stages: every one aims at a plain UsdGeomXformable --
    "aimtest.usda|1,25,50,75,100|-|-|/World/RigRoot/Movers/RigExecAimConstraint1|inputs:defaultWeight|NO|constraints-providers"
    ...
    "rotateConstraint.usda|1,25,50,75,100|-|-|/World/RigRoot/Movers/RigExecRotationConstraint1|inputs:defaultWeight|NO|constraints-providers"
    "rigexec_flat.usda|0,25,50,75,100|-|-|/World/RigRoot/Movers/RigExecAimConstraint1|inputs:defaultWeight|NO|constraints-providers"
    "par_rot_aim.usd|0,25,50,75,100|-|-|/World/RigRoot/Movers/RigExecAimConstraint1|inputs:defaultWeight|NO|constraints-providers"
    "par_rot_aim_redorder.usd|0,25,50,75,100|-|-|/World/RigRoot/Movers/RigExecAimConstraint1|inputs:defaultWeight|NO|constraints-providers"
    "rot_par_combo.usd|0,25,50,75,100|-|-|/World/RigRoot/Movers/RigExecRotationConstraint1|inputs:defaultWeight|NO|constraints-providers"
    "aim_par_combo_flattened.usd|0,25,50,75,100|-|-|/World/RigRoot/Movers/RigExecAimConstraint1|inputs:defaultWeight|NO|constraints-providers"
