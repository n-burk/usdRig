...
# calls through the configured provider (including local Apple FM, Ollama, or
# LM Studio) and asserts the outcome by reading the stage back.
#
...
def testUsdviewInputFunction(appController):
    ...
    # Local Apple FM, Ollama, and LM Studio need no hosted credential, so a
    # missing key is only fatal for the hosted back ends.
