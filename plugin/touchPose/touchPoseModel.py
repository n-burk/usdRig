...
class TouchModel(object):
    ...
    #     set, and the conventional tool's shape picks `shaders[colorIndex]` out of it
    ...
    def HoverColor(self, region):
        ...
        is what the conventional tool's shape draws for a hovered item. Falls back to
    ...
    def StateColors(self):
        ...
        0.187), selected (0.277, 0.277, 0.277) -- because the conventional tool
