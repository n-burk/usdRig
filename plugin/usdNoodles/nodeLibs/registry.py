...
3. Adding a plugInfo.json with {"bases": ["UsdNoodles.nodeLibraries.NodeLibrary"]}
...
class NodeLibraryRegistry:
    ...
    def discover(self) -> list[NodeLibrary]:
        ...
        2. Extension namespaces — auto-imported packages under UsdNoodles.extensions
