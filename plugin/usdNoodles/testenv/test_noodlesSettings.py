...
def _ensure_usdviewq_stubs():
    ...
    so that ``UsdNoodles`` continues to resolve through the real
    package finder.
    """
...
try:
    from UsdNoodles.noodlesSettings import NoodlesSettingsDataModel
...
@unittest.skipUnless(_has_module, f"UsdNoodles not available: {_import_error}")
