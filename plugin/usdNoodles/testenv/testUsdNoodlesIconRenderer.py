...
try:
    from UsdNoodles.iconRenderer import CppIconRenderer

    _has_icon_renderer = True
except ImportError as e:
    print(f"UsdNoodles.iconRenderer import failed: {e}")
...
@unittest.skipUnless(_has_icon_renderer, "UsdNoodles.iconRenderer not available")
class TestIconRenderManagerExport(unittest.TestCase):
    ...
    def test_icon_render_manager_symbol_is_resolved(self):
        # iconRenderer.py does `from UsdNoodles.render import IconRenderManager`,
        ...
        import UsdNoodles.iconRenderer as icon_renderer
