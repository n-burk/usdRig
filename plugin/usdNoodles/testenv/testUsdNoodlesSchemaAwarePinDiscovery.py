...
try:
    from UsdNoodles._schema_pin_names import (
...
@unittest.skipUnless(_has_module, "UsdNoodles not available")
...
@unittest.skipUnless(
    _can_create_stage, "UsdNoodles not available or real USD stages crash"
)
