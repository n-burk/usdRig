...
//
// A control-driven counterpart of the conventional ikSplineSolver as the squarebit
// biped uses it for the spine and neck (core/conventional/rig/spline.py driven by
// the spine and the neck. Three control frames (root, mid, end)
...
//
// The the conventional tool spec, as implemented:
...
//     and blended with RigExecSplineIkParams::midFollowWeight (a the conventional tool
...
struct RigExecSplineIkParams {
    ...
    /// contribute: the the conventional tool ikHandle roll / twist attributes.
    double roll = 0.0;
    double twist = 0.0;
