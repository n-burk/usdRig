...
# Editor panel (tests/testUsdviewExecStack.py) on biped_rigged.usda.
#
...
exec "$PY" "$TESTUSDVIEW" --testScript "$RIG/tests/testUsdviewExecStack.py" \
     "$@" "$STAGE"
